 ...
 */
function disle_form_system_theme_settings_alter(&$form, &$form_state) {
	$form['#attached']['library'][] = 'disle/disle-admin';  
	...
	$form['header']['text_btn_header'] = array(
	    ...
	    '#type' => 'textfield',
	    '#default_value' => theme_get_setting('text_btn_header') ? theme_get_setting('text_btn_header') : t('Get a quote'),
	);
