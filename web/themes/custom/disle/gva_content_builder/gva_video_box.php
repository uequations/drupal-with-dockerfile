...
if(!class_exists('element_gva_video_box')):
   class element_gva_video_box{
      ...
      <?php if($style == 'style-1'){ ?>
         <div class="widget video-box-one__single <?php print $el_class;?> clearfix <?php print $style ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <div class="video-box-one__image text-center">
                  <?php if($image){ ?>
                  <img src="<?php print $image ?>" alt="<?php print $title ?>"/>
                  <?php } ?>
               </div>
            <div class="video-box-one__content">
               <a class="video-box-one__link popup-video" href="<?php print $content ?>"><span class="icon"><i class="fa fa-play"></i></span></a>
               <?php if($desc){ ?><div class="video-box-one__desc"><?php print $desc ?></div><?php } ?>
            </div>   
         </div>  
      <?php } ?>  
