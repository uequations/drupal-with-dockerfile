...
if(!class_exists('element_gva_icon_box_classic')):
   class element_gva_icon_box_classic{
            ...
            'fields' => array(
              ...
              array(
               ...
               array(
                  ...
                  'options'   => array(
                     ''           => t('Defaut'),
                     'mb-0'       => t('Remove Margin Bottom'), 
                     'mb-20'      => t('Margin Bottom Small'), 
                     'mb-30'      => t('Margin Bottom Medium'),
                     'mb-50'      => t('Margin Bottom Large'),
                  ),
                  'class'     => 'width-1-4',
                  'default'   => ''
               ),
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <?php if($icon_position == 'top-left'){ ?>
            <div class="widget icon-box-classic-one__single <?php if(count($class)>0) print implode(' ', $class) ?>" <?php if(count($style) > 0) print 'style="'.implode(';', $style ).'"' ?> <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <div class="icon-box-classic-one__wrap">
                  <?php if($icon){ ?>
                     <div class="icon-box-classic-one__highlight-icon">
                  ...
                  <?php } ?>
                  <?php if($title){ ?>
                     <h3 class="icon-box-classic-one__title <?php print $classes_title_text ?>"><?php print $title_html; ?></h3>
                  <?php } ?> 
               </div>
               <div class="icon-box-classic-one__highlight_content verticle-align-<?php print $vertical_align_content ?>">  
                  <?php if($content){ ?>
                     <div class="icon-box-classic-one__desc <?php print $classes_desc_text ?>"><?php print $content; ?></div>
                  <?php } ?>   
               </div>
            </div>
         <?php } ?>
         <?php if($icon_position == 'left'){ ?>
            <div class="widget icon-box-classic-two__single <?php if(count($class)>0) print implode(' ', $class) ?>" <?php if(count($style) > 0) print 'style="'.implode(';', $style ).'"' ?> <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <div class="icon-box-classic-two__wrap">
                  <?php if($icon){ ?>
                     <div class="icon-box-classic-two__highlight-icon">
                        <span class="icon-inner <?php echo $icon_class_inner ?>">
                           <span class="icon-container <?php print $icon_class ?>" <?php print $style_icon ?>>
                              <?php if($icon){ ?><i class="icon <?php print $icon ?>"></i> <?php } ?>
                           </span>
                  ...
                  <?php } ?>
                  <div class="icon-box-classic-two__highlight_content verticle-align-<?php print $vertical_align_content ?>">  
                      <?php if($title){ ?>
                        <h3 class="icon-box-classic-two__title <?php print $classes_title_text ?>"><?php print $title_html; ?></h3>
                     <?php } ?> 
                     <?php if($content){ ?>
                        <div class="icon-box-classic-two__desc <?php print $classes_desc_text ?>"><?php print $content; ?></div>
                     <?php } ?>   
                  </div>
               </div>
            </div>
         ...
         <?php if($icon_position == 'top-left-2'){ ?>
            <div class="widget icon-box-classic-three__single <?php if(count($class)>0) print implode(' ', $class) ?>" <?php if(count($style) > 0) print 'style="'.implode(';', $style ).'"' ?> <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <div class="icon-box-classic-three__wrap">
                  <?php if($icon){ ?>
                     <div class="icon-box-classic-three__highlight-icon">
                        <span class="icon-inner <?php echo $icon_class_inner ?>">
                           <span class="icon-container <?php print $icon_class ?>" <?php print $style_icon ?>>
                              <?php if($icon){ ?><i class="icon <?php print $icon ?>"></i> <?php } ?>
                           </span>
                  ...
                  <?php } ?>
                  <?php if($title){ ?>
                     <h3 class="icon-box-classic-three__title <?php print $classes_title_text ?>"><?php print $title_html; ?></h3>
                  <?php } ?> 
               </div>
               <div class="icon-box-classic-three__highlight_content verticle-align-<?php print $vertical_align_content ?>">  
                  <?php if($content){ ?>
                     <div class="icon-box-classic-three__desc <?php print $classes_desc_text ?>"><?php print $content; ?></div>
                  <?php } ?>   
               </div>
         ...
         <?php if($icon_position=='top-center' || $icon_position=='top-right' || $icon_position=='right' || $icon_position=='left-2'){ ?>
