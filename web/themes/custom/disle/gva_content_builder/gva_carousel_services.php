                        ...
                        print '<div class="item">';
                           if($style=='style-1'){
                              print '<div class="service-one__single">';
                                 print '<div class="service-one__content">';
                                    print '<div class="service-one__icon-inner">';
                                       if($$icon){ 
                           ...
                           if($style=='style-2'){
                              print '<div class="service-two__single">';
                                 print '<div class="service-two__wrap">';
                                    if($$image){
                                       print '<div class="service-two__image"><img src="'. $$image .'" alt="'. $$title .'"/></div>';
                                    }
                                    print '<div class="service-two__content">';
                                       if($$icon){ 
                                          print '<div class="service-two__content-icon"><i class="'. $$icon .'"></i></div>';
                                       }
                                       if($$title){
                                          print '<h3 class="service-two__content-title">' .  $$title . '</h3>';
                                       }
                                    print '</div>';  
                                    print '<div class="service-two__content-inner">';
                                       ...
                                       if($$link){ 
                                          print '<div class="service-two__action"><a class="btn-readmore" href="' . $$link . '"><i class="fa fa-long-arrow-alt-right"></i></a></div>';
                                       } 
                                    print '</div>';  
                                 print '</div>';
                                 if($$link){ 
                           ...
                           if($style=='style-4'){
                              print '<div class="service-four__single">';
                                 if($$image){
                                    print '<div class="service-four__image"><img src="'. $$image .'" alt="'. $$title .'"/></div>';
                                 }
                                 print '<div class="service-four__content">';
                                 print '<div class="service-four__content-inner">';
                                    if($$icon){ 
